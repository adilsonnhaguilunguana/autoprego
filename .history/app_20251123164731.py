...
# -----------------------------
# Rota de health check (Railway)
# -----------------------------
@app.route('/health')
def health_check():
    """Rota para verificar status do sistema (health check)"""
    try:
...
def init_db_command():
    """Comando para inicializar o banco via CLI"""
    with app.app_context():
        init_db()
...
if __name__ == '__main__':
    ...
    debug_mode = True  # Local pode ser True
